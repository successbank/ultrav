    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">홈페이지에 표시될 레이어 팝업을 추가합니다</p>
        </div>
      </div>
        ...
        <Card className="p-6 space-y-6">
          ...
          {formData.contentType === "image" ? (
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">인라인 스타일을 포함한 HTML을 직접 입력합니다</p>
            </div>
          )}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">노출 시작일</label>
              <Input
                type="datetime-local"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">노출 종료일</label>
              <Input
                type="datetime-local"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, width: parseInt(e.target.value) || 480 })}
                min={200}
                max={800}
              />
