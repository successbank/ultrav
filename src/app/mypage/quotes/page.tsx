  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">내 견적서</h2>
          <p className="text-gray-600 mt-1">받은 견적서를 확인하고 승인할 수 있습니다</p>
        </div>
            ...
            return (
              <Card key={quote.id} className="p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-start justify-between">
                  ...
                  <Link href={`/mypage/quotes/${quote.id}`}>
