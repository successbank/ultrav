...
import { ArrowLeft, Download, Mail, Phone, MapPin, Check, X } from "lucide-react"
        ...
        <Card className="p-6 bg-green-50 border-green-200">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h4 className="font-semibold text-green-900 mb-1">견적서가 승인되었습니다</h4>
      ...
      {quote.status === "REJECTED" && (
        <Card className="p-6 bg-red-50 border-red-200">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-red-900 mb-1">견적서가 거부되었습니다</h4>
              <p className="text-sm text-red-700">
                다른 조건으로 견적을 다시 요청하시려면 영업매니저에게 문의하세요.
              </p>
            </div>
          </div>
        </Card>
